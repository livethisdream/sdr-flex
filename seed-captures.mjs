...
//
// The repository ships two synthetic captures for the conformance harness, but the
// library scans one flat directory and the fixtures live one directory deeper — so a
